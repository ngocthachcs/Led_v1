...
<head>
    ...
    <link rel='stylesheet' id='apsp-frontend-css-css' href='{{ URL('assets/content/plugins/accesspress-pinterest/css/frontend.css?ver=3.1.9')}}' type='text/css' media='all' />
    ...
    <link rel='stylesheet' id='woocommerce-smallscreen-css' href='{{ URL('assets/assets/css/woocommerce-smallscreen.css')}}' type='text/css' media='only screen and (max-width: 768px)' />
    <link rel="stylesheet" type="text/css" href="{{ URL('assets/assets/css/prettyPhoto.css')}}">
    <link rel='stylesheet' id='woocommerce-general-css' href='{{ URL('assets/assets/css/woocommerce.css')}}' type='text/css' media='all' />
    <link rel='stylesheet' id='yith-quick-view-css' href='{{ URL('assets/content/plugins/yith-woocommerce-quick-view/assets/css/yith-quick-view.css?ver=4.8.5')}}' type='text/css' media='all' />
    ...
    <!-- <link rel="icon" href="content/uploads/2017/06/cropped-ico-led-32x32.png" sizes="32x32" /> -->
    <!-- <link rel="icon" href="content/uploads/2017/06/cropped-ico-led-192x192.png" sizes="192x192" /> -->
...
?>
<body class="archive post-type-archive post-type-archive-product wp-custom-logo woocommerce woocommerce-page group-blog hfeed" style="width: 100%">
    <div id="page" class="site">
                            ...
                            <div id="content" role="main">
                                ...
                                <form class="woocommerce-ordering" method="get">
                                    <select name="orderby" class="orderby">
                                        ...
                                        <option value="1" @if($reqInit['orderby'] == 1) selected='selected' @endif>Thứ tự theo sản phẩm mới</option>
                                        <option value="2" @if($reqInit['orderby'] == 2) selected='selected' @endif>Thứ tự theo giá: thấp đến cao</option>
                                        <option value="3" @if($reqInit['orderby'] == 3) selected='selected' @endif>Thứ tự theo giá: cao xuống thấp</option>
                                    </select>
                                </form>
                                <ul class="products">
                                    <?php $i = 0;?>
                                    @foreach($listSanPhams as $sp)
                                    <?php $i++;?>
                                    <li class="post-4664 product type-product status-publish has-post-thumbnail instock shipping-taxable purchasable product-type-simple @if($i % 4 == 0) last @elseif ($i % 4 == 1) first @endif">
                                        <div class="ncn_product_catalog">
                                          <a href="{{URL('/')}}/san-pham/{{$sp->slug}}" class="woocommerce-LoopProduct-link woocommerce-loop-product__link">
                                             <img width="194" height="166" src="{{URL('/')}}/{{$sp->img}}" class="attachment-shop_catalog size-shop_catalog wp-post-image"/>
                                          </a>
                                          <div class="ncn_cart_wrap clearfix">
                                             <a rel="nofollow" href="" class="button product_type_simple add_to_cart_button ajax_add_to_cart">Mua ngay {{$i}}</a>
                                                <!-- <a href="#" class="button yith-wcqv-button" data-product_id="4664">Quick View</a></div> -->
                                          </div>
                                       <h3 class="ncn_products_title text-center">
                                          <a href="{{URL('/')}}/san-pham/{{$sp->slug}}">{{$sp->title}}</a>
                                       </h3>
                                ...
                                <div class="text-right">
                                    {{ $listSanPhams->appends(['orderby' => $reqInit['orderby']])->render() }}
                                </div>
                            </div>
                        </div>
                    </main>
        ...
        <div class="mobile-menu-container">
            ...
            <ul id="moblie-menu" class="moblie-menu">
                <li id="menu-item-2676" class="menu-item menu-item-type-post_type menu-item-object-page menu-item-home current-menu-item page_item page-item-2675 current_page_item menu-item-2676"><a href="/">TRANG CHỦ</a></li>
                <li id="menu-item-4912" class="menu-item menu-item-type-taxonomy menu-item-object-product_cat menu-item-has-children menu-item-4912"><a href="/danh-muc/den-trang-tri">LIST DANH MỤC</a></li>
                <li id="menu-item-2759" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-2759"><a href="#">Giới thiệu</a></li>
                <li id="menu-item-2759" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-2759"><a href="#">Cửa Hàng</a></li>
                <li id="menu-item-2758" class="menu-item menu-item-type-custom menu-item-object-custom menu-item-2758"><a href="#">LIÊN HỆ</a></li>
            </ul>
